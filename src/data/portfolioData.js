...
export const certificates = {
  featured: [
    ...
    { name: "GenAI & Data Science Educator", issuer: "data.mind.hq · Daily Lessons", icon: "📚", link: "https://instagram.com/data.mind.hq" },
  ],
...
export const footerContent = {
  ...
  location: "Based in Washington, DC. From Shahada, Maharashtra, India.",
