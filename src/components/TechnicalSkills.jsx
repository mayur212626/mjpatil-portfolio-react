...
const SkillCard = ({ category, index }) => (
  <div 
    ...
    className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:scale-[1.02] hover:border-indigo-500/30 hover:shadow-[0_20px_50px_rgba(99, 102, 241,0.1)] transition-all duration-500"
  >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div data-aos="fade-up" className="mb-16 text-center">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
            A comprehensive overview of my languages, ML frameworks, data engineering, cloud, and MLOps toolkit.
          </p>
        </div>
