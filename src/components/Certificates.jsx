...
const Certificates = () => {
  return (
    <section className="bg-gradient-to-br from-[#6366f1] to-[#8b5cf6] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-12 md:mb-16 text-center">
          ...
          <p className="text-indigo-100 text-base md:text-lg font-semibold max-w-lg mx-auto">
            Standout results from my ML projects and research.
          </p>
        </div>
